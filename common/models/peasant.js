module.exports = function(Peasant) {
  Peasant.validateAsync('username', customValidator, {
    message: 'Bad name'
  });
  ...
  function customValidator(err, done) {
    ...
    process.nextTick(function() {
      setTimeout(function() {
        ...
        console.log("PROPERTY VALUE IS: %j", self.username );
        if (self.username == "bad") return err();
        done();
        //done( err );
  ...
  Peasant.afterValidate = function(next) {
    console.log("AfterValidation hook performing operations...");
